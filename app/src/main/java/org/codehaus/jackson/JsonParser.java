    ...
    implements Closeable
{
    ...
    public enum Feature {
         ...
         * close the underlying {@link java.io.InputStream} and {@link java.io.Reader}
         * instances used to create the parser. If enabled, parser
         * will handle closing, as long as parser itself gets closed:
         * this happens when end-of-input is encountered, or parser
         * is closed by a call to {@link org.codehaus.jackson.JsonParser#close}.
         *<p>
     ...
     * as {@link java.io.InputStream} or {@link java.io.Reader}) parser does NOT
     ...
     * (check {@link org.codehaus.jackson.JsonParser.Feature} for list of features)
     *
     * @since 1.2
     */
    ...
    /**
     * Method for checking whether specified {@link org.codehaus.jackson.JsonParser.Feature}
     * is enabled.
     *
     * @since 1.2
     */
    ...
    /** @deprecated Use {@link #enable(org.codehaus.jackson.JsonParser.Feature)} instead
     */
    public void enableFeature(Feature f) { enable(f); }

    /** @deprecated Use {@link #disable(org.codehaus.jackson.JsonParser.Feature)} instead
     */
    public void disableFeature(Feature f) { disable(f); }

    /** @deprecated Use {@link #isEnabled(org.codehaus.jackson.JsonParser.Feature)} instead
     */
     ...
     * and if {@link org.codehaus.jackson.JsonToken#FIELD_NAME} is returned, another
     ...
     *   parsers, {@link org.codehaus.jackson.JsonToken#NOT_AVAILABLE} if no tokens were
     *   available yet)
     *
     * @since 0.9.7
     */
     ...
     * {@link org.codehaus.jackson.JsonToken#START_OBJECT} or {@link org.codehaus.jackson.JsonToken#START_ARRAY}.
     * If not, it will do nothing.
     * After skipping, stream will point to <b>matching</b>
     * {@link org.codehaus.jackson.JsonToken#END_OBJECT} or {@link org.codehaus.jackson.JsonToken#END_ARRAY}
     ...
     * the current token: for {@link org.codehaus.jackson.JsonToken#FIELD_NAME}s it will
     ...
     * {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_INT} or
     * {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_FLOAT}, returns
     * one of {@link org.codehaus.jackson.JsonParser.NumberType} constants; otherwise returns null.
     */
     ...
     * token is of type {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_INT} and
     * it can be expressed as a value of Java byte primitive type.
     * It can also be called for {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_FLOAT};
     ...
     * and then constructing a {@link java.math.BigInteger} from that value.
     */
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_FLOAT} and
     * it can be expressed as a Java float primitive type.
     * It can also be called for {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_INT};
    ...
    /**
     * Numeric accessor that can be called when the current
     * token is of type {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_FLOAT} or
     * {@link org.codehaus.jackson.JsonToken#VALUE_NUMBER_INT}. No under/overflow exceptions
     * are ever thrown.
     */
     ...
     * token is {@link org.codehaus.jackson.JsonToken#VALUE_TRUE} or
     * {@link org.codehaus.jackson.JsonToken#VALUE_FALSE}.
     *<p>
 ...
 an integer, but its value falls
     ...
     * is {@link org.codehaus.jackson.JsonToken#VALUE_EMBEDDED_OBJECT}. For other token types,
     * null is returned.
     *<p>
     ...
     * (and for {@link org.codehaus.jackson.JsonToken#VALUE_EMBEDDED_OBJECT})
     ...
     * represented by root {@link org.codehaus.jackson.JsonNode} of resulting model.
