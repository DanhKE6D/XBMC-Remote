...
{    
     ...
     * Used for standard metadata types, except for {@link org.codehaus.jackson.annotate.JsonTypeInfo.Id#NONE}.
     * May or may not be used for custom types ({@link org.codehaus.jackson.annotate.JsonTypeInfo.Id#CUSTOM}).
     */
    public enum As {
        /**
     ...
     * {@link org.codehaus.jackson.annotate.JsonTypeInfo.Id#NONE} nothing is included). Default
     *<p>
     * Note that for type metadata type of {@link org.codehaus.jackson.annotate.JsonTypeInfo.Id#CUSTOM},
     * this setting may or may not have any effect.
     */
    public As include() default As.PROPERTY;

    /**
     * Property names used when type inclusion method ({@link org.codehaus.jackson.annotate.JsonTypeInfo.As#PROPERTY}) is used
     * (or possibly when using type metadata of type {@link org.codehaus.jackson.annotate.JsonTypeInfo.Id#CUSTOM}).
     *<p>
