    ...
    extends ObjectCodec
{
    ...
    /**
     * Enumeration used with {@link org.codehaus.jackson.map.ObjectMapper#enableDefaultTyping()}
    ...
    /**
     * Customized {@link org.codehaus.jackson.map.jsontype.TypeResolverBuilder} that provides
     * resolver builders based on its configuration. It is used
     * when default typing is enabled (see
     * {@link org.codehaus.jackson.map.ObjectMapper#enableDefaultTyping()} for details).
     */
     ...
     * {@link org.codehaus.jackson.map.ser.StdSerializerProvider} as its
     * {@link SerializerProvider}, and
     * {@link org.codehaus.jackson.map.ser.BeanSerializerFactory} as its
     ...
     * @param sp SerializerProvider to use: if null, a {@link org.codehaus.jackson.map.ser.StdSerializerProvider} will be constructed
     * @param dp DeserializerProvider to use: if null, a {@link org.codehaus.jackson.map.deser.StdDeserializerProvider} will be constructed
    ...
    */
     ...
     * {@link #writeValue(java.io.Writer,Object)} with {@link java.io.StringWriter}
     ...
     * {@link #writeValue(java.io.Writer,Object)} with {@link java.io.ByteArrayOutputStream}
     ...
     *  provide more tokens.
     *
     * @throws java.io.IOException if the underlying input source has problems during
     *   parsing
