 ...
 * process. An instance is owned by {@link org.codehaus.jackson.map.ObjectMapper}, which makes
 * a copy that is passed during serialization process to
 * {@link org.codehaus.jackson.map.SerializerProvider} and {@link org.codehaus.jackson.map.SerializerFactory}.
 *<p>
    ...
    implements MapperConfig<SerializationConfig>
{
    ...
    public enum Feature {
         ...
         *
         * @deprecated As of 1.1, use {@link org.codehaus.jackson.map.SerializationConfig#setSerializationInclusion}
         *    instead
         */
         ...
         * or field level by using {@link org.codehaus.jackson.map.annotate.JsonSerialize#typing} annotation
         * property
         */
     ...
     * {@link org.codehaus.jackson.map.SerializationConfig.Feature#WRITE_DATES_AS_TIMESTAMPS} being set to false).
     * Defaults to a ISO-8601 compliant format used by
     * {@link org.codehaus.jackson.map.util.StdDateFormat}.
     *<p>
     ...
     * will check
     * deprecated {@link org.codehaus.jackson.map.SerializationConfig.Feature#WRITE_NULL_PROPERTIES}
     * to choose between {@link org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion#ALWAYS}
     * and {@link org.codehaus.jackson.map.annotate.JsonSerialize.Inclusion#NON_NULL}.
     */
    protected Inclusion _serializationInclusion = null;
     ...
     * <li>{@link org.codehaus.jackson.map.annotate.JsonSerialize#typing}</li>
     *</ul>
     * 
    ...
    public void fromAnnotations(Class<?> cls)
    {
        ...
        Inclusion incl = _annotationIntrospector.findSerializationInclusion(ac, null);
    ...
    public Inclusion getSerializationInclusion()
    {
        ...
        return isEnabled(Feature.WRITE_NULL_PROPERTIES) ?
            Inclusion.ALWAYS : Inclusion.NON_NULL;
    }
   ...
   /**
     ...
     * {@link org.codehaus.jackson.map.SerializationConfig.Feature#WRITE_DATES_AS_TIMESTAMPS}: enable, if argument
