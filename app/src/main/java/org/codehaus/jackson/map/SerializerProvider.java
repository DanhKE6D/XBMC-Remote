...
/**
 * Abstract class that defines API used by {@link org.codehaus.jackson.map.ObjectMapper} and
 * {@link org.codehaus.jackson.map.JsonSerializer}s to obtain serializers capable of serializing
 * instances of specific types.
 *<p>
 * Note about usage: for {@link org.codehaus.jackson.map.JsonSerializer} instances, only accessors
 * for locating other (sub-)serializers are to be used. {@link org.codehaus.jackson.map.ObjectMapper},
...
public abstract class SerializerProvider
{
    ...
    /**
     * The method to be called by {@link org.codehaus.jackson.map.ObjectMapper} to
     ...
     * to also use a {@link org.codehaus.jackson.map.TypeSerializer} based on declared (static) type
     ...
     * to use; typically when none of {@link org.codehaus.jackson.map.SerializerFactory}
