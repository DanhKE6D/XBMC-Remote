 ...
 * {@link org.codehaus.jackson.map.ser.BeanSerializerFactory} (and its super class,
 * {@link org.codehaus.jackson.map.ser.BasicSerializerFactory}) are used if no overrides are
 * defined.
 *<p>
 * Unlike base serializer factories ({@link org.codehaus.jackson.map.ser.BasicSerializerFactory},
 * {@link org.codehaus.jackson.map.ser.BeanSerializerFactory}), this factory is stateful because
