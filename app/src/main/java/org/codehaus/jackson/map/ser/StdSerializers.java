...
public class StdSerializers
{
    ...
    /**
     * Similar to {@link org.codehaus.jackson.map.ser.StdSerializers.IntegerSerializer}, but will not cast to Integer:
     * instead, cast is to {@link Number}, and conversion is
     * by calling {@link Number#intValue}.
     */
    ...
    /**
     * This is the special serializer for regular {@link Double}s
    ...
    /**
     * Compared to regular {@link org.codehaus.jackson.map.ser.StdSerializers.UtilDateSerializer}, we do use String
