...
public class MovieLibraryActivity extends SlidingTabActivity implements ViewTreeObserver.OnGlobalLayoutListener {
    private static final String TAG = "MovieLibraryActivity";
    ...
    public void onTitlebarClicked(View v) {
        LOG.I(TAG, "onTitlebarClicked()");
        // dql -- simulate option menu
        openOptionsMenu();
    }
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        LOG.I(TAG, "MovieLibraryActivity.onCreate()");
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
        LOG.I(TAG, "MovieLibraryActivity.onPrepareOptionsMenu():");
		menu.clear();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 1:
			...
			break;
		case 2:
            LOG.I(TAG, "MovieLibraryActivity.onOptionsItemSelected(): Tab is FILE LIST");
